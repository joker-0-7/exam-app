    ...
    <div className="overflow-x-auto text-center">
      <table className="min-w-full divide-y-2 divide-gray-200 bg-white text-sm rounded-lg">
        <thead className="ltr:text-left rtl:text-right bg-gray-50">
          <tr>
            <th className="whitespace-nowrap px-4 py-2 text-gray-900">Name</th>
            <th className="whitespace-nowrap px-4 py-2 text-gray-900">email</th>
            <th className="whitespace-nowrap px-4 py-2 text-gray-900">
              Status
            </th>
            <th className="whitespace-nowrap px-4 py-2 text-gray-900">Since</th>
            <th className="whitespace-nowrap px-4 py-2 text-gray-900">
              Active to
            </th>
          ...
          {rows.map((user, i) => {
            return (
              <tr key={user._id}>
                ...
                <td className="whitespace-nowrap px-4 py-2 flex justify-evenly"></td>
                <td className="whitespace-nowrap px-4 py-2 flex justify-evenly">
                  <button
